...
namespace CausalInfMSI
{
	public class DataController
	{
		...
		public DataController(List<string> variableList, string path, string subjectID, string task)
		{
		...
		public void Activate()
		{
			...
			var filePath = Path.Combine(_dataPath, _subjectID + _task + "_" + timeStamp + ".csv");
